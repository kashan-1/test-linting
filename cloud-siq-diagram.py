...
with Diagram(
    "SIQ Architecture-Infrastructure View",
    show=False,
    ...
    with Cluster(
        "", graph_attr={"bgcolor": "transparent", "penwidth": "0"}, direction="TB"
    ):
        ...
        (
            bed
            >> Edge(label="Device\nAdmin", style="", color="black", labeljust="c")
            >> domain1
        )
        (
            bed
            >> Edge(label="Device\nGateway", style="", color="black", labeljust="c")
            >> domain2
        )
        (
            csp_hd_app
            >> Edge(label="User\nInterface", style="", color="black", labeljust="c")
            >> domain3
        )
        (
            csp_hd_app
            >> Edge(label="Frontend\n REST API", style="", color="black", labeljust="c")
            >> domain4
        )
        (
            customer_service
            >> Edge(label="Static\nPages", style="", color="black", labeljust="c")
            >> domain5
        )
        (
            customer_service
            >> Edge(label="REST API", style="", color="black", labeljust="c")
            >> domain6
        )
        ...
        (
            users_biz
            >> Edge(
                label="Products\nOps Portal", style="", color="black", labeljust="c"
            )
            >> domain9
        )
        (
            users_biz
            >> Edge(label="Ops center", style="", color="black", labeljust="c")
            >> domain10
        )
        (
            users_tech
            >> Edge(label="SSh/Tunnel", style="", color="black", labeljust="c")
            >> domain11
        )

        with Cluster(
            "Public IP Subnet", graph_attr={"bgcolor": "transparent", "penwidth": "1"}
        ):
        ...
        with Cluster(
            "Private IP Subnet", graph_attr={"bgcolor": "transparent", "penwidth": "1"}
        ):
            ...
            with Cluster(
                ...
                (
                    instances_3
                    >> Edge(label="", style="", color="black", constraint="false")
                    >> ELB_8
                )
                (
                    instances_4
            ...
            with Cluster(
                ...
                hazelcast_1 = Custom(
                    "Hazelcast\nCluster",
                    "259332_cluster_compute_copy_emr_hdfs_icon.png",
                )
                ...
                c_1 = Custom(
                    "C* (DSE)", "259332_cluster_compute_copy_emr_hdfs_icon.png"
                )
                emr_1 = Custom(
